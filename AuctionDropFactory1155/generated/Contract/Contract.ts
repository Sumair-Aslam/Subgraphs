...
export class Contract extends ethereum.SmartContract {
  ...
  createAuctionDrop(
    ...
    let result = super.call(
      "createAuctionDrop",
      "createAuctionDrop(bytes32,uint256,uint256,(address,uint256[],uint256[],uint256[])[]):(address)",
      [
...
export class __AuctionDropFactory_initCall extends ethereum.Call {
  get inputs(): __AuctionDropFactory_initCall__Inputs {
    return new __AuctionDropFactory_initCall__Inputs(this);
  }

  get outputs(): __AuctionDropFactory_initCall__Outputs {
    return new __AuctionDropFactory_initCall__Outputs(this);
  }
}

export class __AuctionDropFactory_initCall__Inputs {
  _call: __AuctionDropFactory_initCall;

  constructor(call: __AuctionDropFactory_initCall) {
    this._call = call;
  }
...
export class __AuctionDropFactory_initCall__Outputs {
  _call: __AuctionDropFactory_initCall;
