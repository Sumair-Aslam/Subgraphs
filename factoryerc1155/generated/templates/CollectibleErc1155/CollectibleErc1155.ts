...
export class CollectibleErc1155 extends ethereum.SmartContract {
  static bind(address: Address): CollectibleErc1155 {
    return new CollectibleErc1155("CollectibleErc1155", address);
  }
...
export class LazyMintCall__Inputs {
  ...
  get nftVoucher(): LazyMintCallNftVoucherStruct {
    return changetype<LazyMintCallNftVoucherStruct>(
...
export class LazyMintCallNftVoucherStruct extends ethereum.Tuple {
  get tokenId(): BigInt {
